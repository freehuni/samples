...
// 2013/7/4 mhkang:
//    libsoup, glib library가 없으면 다운 받아야함. path설정은 .pro 파일 참고해서 할 것
...
int main()
{
	...
	SoupMessage* msg = soup_message_new("GET", "http://192.168.0.7:2869/upnphost/udhisapi.dll?content=uuid:bb668bf2-450b-45a5-a944-6f75f991a2ec");
...
static void server_callback (SoupServer *server, SoupMessage *msg,  const char *path, GHashTable *query, SoupClientContext *context, gpointer data)
{
	...
	// http root
	//file_path = g_strdup_printf ("/home/mhkang2/http_root/%s", path);
	file_path = g_strdup_printf ("/home/mhkang2/video/%s", path);
