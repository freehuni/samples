...
static void resource_available_cb (G_GNUC_UNUSED GSSDPResourceBrowser *resource_browser,  const char *usn, GList *locations, gpointer user_data)
{
        GList *l;
...
static void resource_unavailable_cb (G_GNUC_UNUSED GSSDPResourceBrowser *resource_browser, const char *usn)
{
...
int main (G_GNUC_UNUSED int    argc,  G_GNUC_UNUSED char **argv)
{
      ...
      //  gssdp_client_append_header(client, "my_field", "mhkang");

        // ssdp:all 로 m-search 전송함.
